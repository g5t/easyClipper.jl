...
test("Union") do
    ...
    @test result == true
    @test polys[1][1] == easyClipper.IntPoint(0, 0)
    @test polys[1][2] == easyClipper.IntPoint(2, 0)
    @test polys[1][3] == easyClipper.IntPoint(2, 1)
    @test polys[1][4] == easyClipper.IntPoint(0, 1)
    ...
    @test contour(pn)[1] == easyClipper.IntPoint(0, 0)
    @test contour(pn)[2] == easyClipper.IntPoint(2, 0)
    @test contour(pn)[3] == easyClipper.IntPoint(2, 1)
    @test contour(pn)[4] == easyClipper.IntPoint(0, 1)
end
...
test("Difference") do
    ...
    @test result == true
    @test polys[1][1] == easyClipper.IntPoint(10, 10)
    @test polys[1][2] == easyClipper.IntPoint(6, 10)
    @test polys[1][3] == easyClipper.IntPoint(6, 0)
    @test polys[1][4] == easyClipper.IntPoint(10, 0)

    @test polys[2][1] == easyClipper.IntPoint(0, 10)
    @test polys[2][2] == easyClipper.IntPoint(0, 0)
    @test polys[2][3] == easyClipper.IntPoint(4, 0)
    @test polys[2][4] == easyClipper.IntPoint(4, 10)
    ...
    @test contour(pn1)[1] == easyClipper.IntPoint(10, 10)
    @test contour(pn1)[2] == easyClipper.IntPoint(6, 10)
    @test contour(pn1)[3] == easyClipper.IntPoint(6, 0)
    @test contour(pn1)[4] == easyClipper.IntPoint(10, 0)

    @test contour(pn2)[1] == easyClipper.IntPoint(0, 10)
    @test contour(pn2)[2] == easyClipper.IntPoint(0, 0)
    @test contour(pn2)[3] == easyClipper.IntPoint(4, 0)
    @test contour(pn2)[4] == easyClipper.IntPoint(4, 10)
end
...
test("PolyTrees / PolyNodes") do
    ...
    @test parent(pn1) === pt
    @test length(children(pn1)) == 1
    @test contour(pn1)[1] == easyClipper.IntPoint(8, 8)
    @test contour(pn1)[2] == easyClipper.IntPoint(0, 8)
    @test contour(pn1)[3] == easyClipper.IntPoint(0, 0)
    @test contour(pn1)[4] == easyClipper.IntPoint(8, 0)
    ...
    @test parent(pn2) === pn1
    @test length(children(pn2)) == 1
    @test contour(pn2)[1] == easyClipper.IntPoint(1, 1)
    @test contour(pn2)[2] == easyClipper.IntPoint(1, 7)
    @test contour(pn2)[3] == easyClipper.IntPoint(7, 7)
    @test contour(pn2)[4] == easyClipper.IntPoint(7, 1)
    ...
    @test contour(pn3)[1] == easyClipper.IntPoint(6, 6)
    @test contour(pn3)[2] == easyClipper.IntPoint(2, 6)
    @test contour(pn3)[3] == easyClipper.IntPoint(2, 2)
    @test contour(pn3)[4] == easyClipper.IntPoint(6, 2)
